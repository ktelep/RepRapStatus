...
class pyRepRapComm:
    ...
    def get_status_info(self, status_type=1):
        ...
        """
        status_url = self.base_url + self.status_path + "?Type=" + str(status_type)
    ...
    def get_printer_temps(self, status_data=None):
        ...
        temps['bed']['formatted'] = "{}/{}".format(temps['bed']['current'],
                                                   temps['bed']['target'])
        ...
        combined_nozzles = list(zip(print_status['temps']['current'][1:],  # Second entry is first noz
                                    print_status['temps']['tools']['active'],
                                    print_status['temps']['tools']['standby']))

        counter = 0
        for nozzle in combined_nozzles:
            nozzle_formatted = "{}/{}".format(nozzle[0], nozzle[1][0])
    ...
    def get_print_info(self):
        ...
        print_info['PercentComplete']['formatted'] = str(print_status['fractionPrinted']) + '%'
        ...
        print_info['layers']['formatted'] = "{}/{}".format(current_layer, int(total_layers))
